    ...
    IExpensesUpdateOnlyRepository
{
    ...
    {
        //A função "AsNoTracking" melhora a performance quando vamos fazer somente a consulta.
        return await _dbContext.Expenses.AsNoTracking().ToListAsync();

        //Ele melhora a performance pq normalmente, quando fazemos consultas, o banco armazena um cache, se preparando para uma alteração.
        //E isso não é necessário só em consultas.
    }
