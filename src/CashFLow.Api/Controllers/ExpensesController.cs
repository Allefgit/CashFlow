...
public class ExpensesController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ErrorsOnValidationException), StatusCodes.Status400BadRequest)]
    ...
    public async Task<IActionResult> GetById(
        [FromServices] IGetExpanseByIdUseCase useCase,
        [FromRoute] long id
        )
    {
    ...
    [ProducesResponseType(typeof(RequestExpenseJson), StatusCodes.Status404NotFound)]
